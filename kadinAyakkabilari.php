                                ...
                                ?>
                                    <td width="193" valign="top">
                                        <table width="193" align="left" border="0" cellpadding="0" cellspacing="0" style="margin-bottom: 10px;"> <!-- style="border: 1px solid #CCC; margin-bottom: 10px;" -->
                                            <tr height="40">
                                                <td align="center"><a href="index.php?sayfakodu=83&id=<?php echo donusumleriGeriDondur($urun["id"]); ?>"><img src="resimler/urunResimleri/Kadin/<?php echo donusumleriGeriDondur($urun["urunResmiBir"]); ?>" alt="Ürün Resmi" border="0" width="185" height="247"></a></td>
                                            </tr>
                                            <tr height="25">
                                                <td width="253" align="center"><a href="index.php?sayfakodu=83&id=<?php echo donusumleriGeriDondur($urun["id"]); ?>" style="color: #FF9900; font-weight: bold; text-decoration: none;">Kadın Ayakkabısı</a></td>
                                            </tr>
                                            <tr height="25">
