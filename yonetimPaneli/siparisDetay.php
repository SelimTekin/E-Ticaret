...
?>
    <table width="760" align="center" border="0" cellpadding="0" cellspacing="0">
        <tr height="70">
            ...
            <td width="200" colspan="2" bgcolor="#FF9900" align="right"><a href="index.php?sayfaKoduDis=0&sayfaKoduIc=106" style="color: #FFF; text-decoration: none;">Bekleyen Siparişlere Dön&nbsp;</a></td>
        </tr>
        <tr height="10">
        ...
        ?>
            ...
            <tr>
                <td colspan="2">
                    <form action="index.php?sayfaKoduDis=0&sayfaKoduIc=110&siparisNo=<?php echo donusumleriGeriDondur($gelenSiparisNo); ?>" method="post">
                        <table width="750" align="right" border="0" cellpadding="0" cellspacing="0">
                            <tr height="40">
                                <td colspan="3">
                                    <table width="750" align="right" border="0" cellpadding="0" cellspacing="0">
                                ...
                                <td colspan="3">
                                    <table width="750" align="right" border="0" cellpadding="0" cellspacing="0">
                                        <tr>
                                            <td width="100">&nbsp;</td>
                                            <td width="10">&nbsp;</td>
                                            <td width="540"><input type="submit" value="Gönderi Kodunu İşle ve Siparişi Tamamla" class="maviButon"></td>
                                        </tr>
                                    </table>
                                </td>
                            </tr>
