...
?>
    <table width="760" align="center" border="0" cellpadding="0" cellspacing="0">
        <tr height="70">
            ...
            <td width="200" colspan="2" bgcolor="#FF9900" align="right"><a href="index.php?sayfaKoduDis=0&sayfaKoduIc=83" style="color: #FFF; text-decoration: none;">Silinmiş Üyeler&nbsp;</a></td>
        </tr>
        <tr height="10">
                    ...
                    <tr>
                        <td>
                            <div class="aramaAlani">
                                <form action="index.php?sayfaKoduDis=0&sayfaKoduIc=82" method="post">
                            ...
                            <tr>
                                <td colspan="9" align="right">
                                    <table width="95" align="right" border="0" cellpadding="0" cellspacing="0">
                                        <tr>
                                            <td width="40">&nbsp;</td>
                                            <td width="25" valign="top"><a href="index.php?sayfaKoduDis=0&sayfaKoduIc=84&id=<?php echo donusumleriGeriDondur($uyeler["id"]) ?>"><img src="../resimler/Sil20x20.png" border="0" alt="Sil Butonu"></a></td>
                                            <td width="42" valign="top"><a href="index.php?sayfaKoduDis=0&sayfaKoduIc=84&id=<?php echo donusumleriGeriDondur($uyeler["id"]) ?>" style="color: #FF0000; text-decoration: none;">Sil</a></td>
                                        </tr>
                                    </table>
                                </td>
                            </tr>
                    ...
                    <td align="center">
                        <div class="sayfalamaAlaniKapsayicisi">
                            ...
                            <div class="sayfalamaAlaniIciNumaraAlaniKapsayicisi">
                                <?php
                                if ($sayfalama > 1) {
                                    echo "<span class='sayfalamaPasif'><a href='index.php?sayfaKoduDis=0&sayfaKoduIc=82" . $sayfalamaKosulu . "&sayfalama=1'><<</a></span>";
                                    $sayfalamaIcinSayfaDegeriBirGeriAl = $sayfalama - 1;
                                    echo "<span class='sayfalamaPasif'><a href='index.php?sayfaKoduDis=0&sayfaKoduIc=82" . $sayfalamaKosulu . "&sayfalama=" . $sayfalamaIcinSayfaDegeriBirGeriAl . "'><</a></span>";
                                }
                                ...
                                for ($sayfalamaIcinSayfaIndexDegeri = $sayfalama - $sayfalamaIcinSolveSagButonSayisi; $sayfalamaIcinSayfaIndexDegeri <= $sayfalama + $sayfalamaIcinSolveSagButonSayisi; $sayfalamaIcinSayfaIndexDegeri++) {
                                    if (($sayfalamaIcinSayfaIndexDegeri > 0) and ($sayfalamaIcinSayfaIndexDegeri <= $bulunanSayfaSayisi)) {
                                        if ($sayfalama == $sayfalamaIcinSayfaIndexDegeri) {
                                            ...
                                            echo "<span class='sayfalamaPasif'><a href='index.php?sayfaKoduDis=0&sayfaKoduIc=82" . $sayfalamaKosulu . "&sayfalama=" . $sayfalamaIcinSayfaIndexDegeri . "'>$sayfalamaIcinSayfaIndexDegeri</a></span>";
                                        }
                                    }
                                }
                                ...
                                if ($sayfalama != $bulunanSayfaSayisi) {
                                    ...
                                    echo "<span class='sayfalamaPasif'><a href='index.php?sayfaKoduDis=0&sayfaKoduIc=82" . $sayfalamaKosulu . "&sayfalama=" . $sayfalamaIcinSayfaDegeriBirIleriAl . "'>></a></span>";
                                    echo "<span class='sayfalamaPasif'><a href='index.php?sayfaKoduDis=0&sayfaKoduIc=82" . $sayfalamaKosulu . "&sayfalama=" . $bulunanSayfaSayisi . "'>>></a></span>";
                                }
                                ?>
                            </div>
                        </div>
