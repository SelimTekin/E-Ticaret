...
$toplamKayitSayisiSorgusu           = $db->prepare("SELECT * FROM urunler WHERE urunTuru = 'Kadın Ayakkabısı' AND durumu = '1' $menuKosulu $aramaKosulu ORDER BY id DESC");
...
$anaMenununTumUrunSayiSorgusu = $db->prepare("SELECT SUM(urunSayisi) AS menununToplamUrunu FROM menuler WHERE urunTuru = 'Kadın Ayakkabısı'");
                ...
                <tr>
                    <td>
                        <table width="250" align="center" border="0" cellpadding="0" cellspacing="0">
                            ...
                            <tr height="30">
                                <td><a href="index.php?sayfaKodu=85" style="text-decoration: none; <?php if ($gelenMenuId == "") { ?> color: #FF9900; <?php } else { ?> color: #646464; <?php } ?> font-weight: bold;">&nbsp;Tüm Ürünler (<?php echo $anaMenununTumUrunSayiSorgusu["menununToplamUrunu"]; ?>)</a></td>
                            </tr>
                            <?php
                            $menulerSorgusu  = $db->prepare("SELECT * FROM menuler WHERE urunTuru = 'Kadın Ayakkabısı' ORDER BY menuAdi ASC");
                            ...
                            ?>
                                ...
                                <tr height="30">
                                    <td><a href="index.php?sayfaKodu=85&menuId=<?php echo $menu["id"]; ?>" style="text-decoration: none; <?php if ($gelenMenuId == $menu['id']) { ?> color: #FF9900; <?php } else { ?> color: #646464; <?php } ?> font-weight: bold;">&nbsp;<?php echo donusumleriGeriDondur($menu["menuAdi"]); ?> (<?php echo donusumleriGeriDondur($menu["urunSayisi"]); ?>)</a></td>
                                </tr>
                ...
                <tr>
                    <td>
                        <div class="aramaAlani">
                            <form action="index.php?sayfaKodu=85" method="post">
                                <?php if($gelenMenuId != ""){ ?>
                    ...
                    <td>
                        ...
                        <table align="left" border="0" cellpadding="0" cellspacing="0">
                            <tr>
                                ...
                                $urunlerSorgusu = $db->prepare("SELECT * FROM urunler WHERE urunTuru = 'Kadın Ayakkabısı' AND durumu = '1' $menuKosulu $aramaKosulu ORDER BY id DESC LIMIT $sayfalamayaBaslanacakKayitSayisi, $sayfaBasinaGosterilecekKayitSayisi");
                                ...
                                ?>
                                    <td width="193" valign="top">
                                        <table width="193" align="left" border="0" cellpadding="0" cellspacing="0" style="margin-bottom: 10px;"> <!-- style="border: 1px solid #CCC; margin-bottom: 10px;" -->
                                            <tr height="40">
                                                <td align="center"><a href="urun-detay/<?php echo SEO(donusumleriGeriDondur($urun["urunAdi"])); ?>/<?php echo donusumleriGeriDondur($urun["id"]); ?>"><img src="resimler/urunResimleri/Kadin/<?php echo donusumleriGeriDondur($urun["urunResmiBir"]); ?>" alt="Ürün Resmi" border="0" width="185" height="247"></a></td>
                                            </tr>
                                            <tr height="25">
                                                <td width="253" align="center"><a href="urun-detay/<?php echo SEO(donusumleriGeriDondur($urun["urunAdi"])); ?>/<?php echo donusumleriGeriDondur($urun["id"]); ?>" style="color: #FF9900; font-weight: bold; text-decoration: none;">Kadın Ayakkabısı</a></td>
                                            </tr>
                                            <tr height="25">
                                                <td width="253" align="center"><a href="urun-detay/<?php echo SEO(donusumleriGeriDondur($urun["urunAdi"])); ?>/<?php echo donusumleriGeriDondur($urun["id"]); ?>" style="color: #646464; font-weight: bold; text-decoration: none;"><div style="width: 193px; max-width: 193px; height: 20px; overflow: hidden; line-height: 20px;"><?php echo donusumleriGeriDondur($urun["urunAdi"]); ?></div></a></td>
                                            </tr>
                                            <tr height="25">
                                                <td width="253" align="center"><a href="urun-detay/<?php echo SEO(donusumleriGeriDondur($urun["urunAdi"])); ?>/<?php echo donusumleriGeriDondur($urun["id"]); ?>"><img src="resimler/<?php echo $puanResmi; ?>" alt="Ürün Puanı"></a></td>
                                            </tr>
                                            <tr height="25">
                                                <td width="253" align="center"><a href="urun-detay/<?php echo SEO(donusumleriGeriDondur($urun["urunAdi"])); ?>/<?php echo donusumleriGeriDondur($urun["id"]); ?>" style="color: #0000FF; font-weight: bold; text-decoration: none;"><?php echo fiyatBicimlendir($urunFiyatiHesapla); ?> TL</a></td>
                                            </tr>
                                        </table>
                                    </td>
                                    <?php
                        ...
                        <td align="center">
                            <div class="sayfalamaAlaniKapsayicisi">
                                ...
                                <div class="sayfalamaAlaniIciNumaraAlaniKapsayicisi">
                                    <?php
                                    if ($sayfalama > 1) {
                                        echo "<span class='sayfalamaPasif'><a href='index.php?sayfaKodu=85" . $sayfalamaKosulu . "&sayfalama=1'><<</a></span>";
                                        $sayfalamaIcinSayfaDegeriBirGeriAl = $sayfalama - 1;
                                        echo "<span class='sayfalamaPasif'><a href='index.php?sayfaKodu=85" . $sayfalamaKosulu . "&sayfalama=" . $sayfalamaIcinSayfaDegeriBirGeriAl . "'><</a></span>";
                                    }
                                    ...
                                    for ($sayfalamaIcinSayfaIndexDegeri = $sayfalama - $sayfalamaIcinSolveSagButonSayisi; $sayfalamaIcinSayfaIndexDegeri <= $sayfalama + $sayfalamaIcinSolveSagButonSayisi; $sayfalamaIcinSayfaIndexDegeri++) {
                                        if (($sayfalamaIcinSayfaIndexDegeri > 0) and ($sayfalamaIcinSayfaIndexDegeri <= $bulunanSayfaSayisi)) {
                                            if ($sayfalama == $sayfalamaIcinSayfaIndexDegeri) {
                                                ...
                                                echo "<span class='sayfalamaPasif'><a href='index.php?sayfaKodu=85" . $sayfalamaKosulu . "&sayfalama=" . $sayfalamaIcinSayfaIndexDegeri . "'>$sayfalamaIcinSayfaIndexDegeri</a></span>";
                                            }
                                        }
                                    }
                                    ...
                                    if ($sayfalama != $bulunanSayfaSayisi) {
                                        ...
                                        echo "<span class='sayfalamaPasif'><a href='index.php?sayfaKodu=85" . $sayfalamaKosulu . "&sayfalama=" . $sayfalamaIcinSayfaDegeriBirIleriAl . "'>></a></span>";
                                        echo "<span class='sayfalamaPasif'><a href='index.php?sayfaKodu=85" . $sayfalamaKosulu . "&sayfalama=" . $bulunanSayfaSayisi . "'>>></a></span>";
                                    }
                                    ?>
                                </div>
                            </div>
