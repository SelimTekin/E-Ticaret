<table width="1065" align="center" border="0" cellpadding="0" cellspacing="0">
    <tr>
        <td width="500"  valign="top">
            <form action="index.php?sayfaKodu=38" method="post">
                <table width="500" align="center" border="0" cellpadding="0" cellspacing="0">
                    <tr height="40">
                        <td colspan="2" style="color: #FF9900;"><h3>Şifremi Unuttum</h3></td>
                    </tr>
                    <tr height="40">
                        <td colspan="2" valign="30" style="border-bottom: 1px dashed #CCC;">Aşağıdan hesabına yeni şifre talebi başlatabilirsin.</td>
                    </tr>
                    ...
                    <tr height="40">
                        <td colspan="2" align="center"><input type="submit" value="Yeni Şifre Oluşturma Maili Gönder" class="maviButon"></td>
                    </tr>
